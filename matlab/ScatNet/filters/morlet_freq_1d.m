...
function [xi_psi, bw_psi, bw_phi] = morlet_freq_1d(filt_opt)
    ...
    xi_psi = filt_opt.xi_psi * 2.^((0:-1:1-filt_opt.J)/filt_opt.Q); % start from the finest scale, decraese
    sigma_psi = filt_opt.sigma_psi * 2.^((0:filt_opt.J-1)/filt_opt.Q); % spread of Gaussian envelope, increase
