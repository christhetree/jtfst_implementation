...
def calc_time_scat_transform_1(audio: T,
                               sr: float,
                               J_1: int,
                               Q_1: int = 1,
    ...
    if not should_scatter:
        return scalogram, freqs, wavelet_bank
    ...
    y = scatter(scalogram, scat_win, dim=-1, hop_size=hop_size)
...
if __name__ == "__main__":
    ...
    scalogram, freqs, wavelet_bank = calc_time_scat_transform_1(
        audio, sr, J_1, Q_1, should_scatter, highest_freq=highest_freq)
